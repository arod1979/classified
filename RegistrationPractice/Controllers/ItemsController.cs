...
namespace RegistrationPractice.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Description,LocationID,CategoryID,CreationDate,EmailRelayAddress,Reward,AdditionalNotes,Visits,Returned")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Description,LocationID,CategoryID,CreationDate,EmailRelayAddress,Reward,AdditionalNotes,Visits,Returned")] Item item)
        {
            if (ModelState.IsValid)
            {

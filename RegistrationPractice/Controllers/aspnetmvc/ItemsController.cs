...
namespace RegistrationPractice.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create(string country, string province, string city, string posttypefilter, string action) ////candidate for dependancy injection
        {
            ...
            item.City = city;
            item.LocationID = RegistrationPractice.Classes.Globals.constants.GetCityPrimaryKey(city);
            ...
            switch (posttypefilter)
            {
                case "Stolen":
                    ...
                    item.PostTypeID = RegistrationPractice.Classes.Globals.constants.stolendbid;
                    item.ItemReward = 0;
                    break;
                case "Found":
                    item.PostTypeID = RegistrationPractice.Classes.Globals.constants.founddbid;
                    break;
                case "Lost":
                    item.PostTypeID = RegistrationPractice.Classes.Globals.constants.lostdbid;
                    break;
            }
